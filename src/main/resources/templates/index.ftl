                ...
                <#list list as middleMap >
                    <div class="feed-item folding feed-item-hook feed-item-2
                        ...
                        <div class="feed-item-inner">
                            <div class="avatar">
                                <a title="${middleMap.user.name}" data-tip="p$t$amuro1230" class="zm-item-link-avatar" target="_blank" href="https://nowcoder.com/people/amuro1230">
                                    <img src="${middleMap.user.headUrl}" class="zm-item-img-avatar"></a>
                            </div>
                            <div class="feed-main">
                                <div class="feed-content" data-za-module="AnswerItem">
                                    ...
                                    <h2 class="feed-title">
                                        <a class="question_link" target="_blank" href="/question/${middleMap.question.id}">${middleMap.question.title}</a></h2>
                                    ...
                                    <div class="expandable entry-body">
                                        ...
                                        <div class="zm-item-answer-author-info">
                                            <a class="author-link" data-tip="p$b$amuro1230" target="_blank" href="/user/${middleMap.user.id}">${middleMap.user.name}</a>
                                            ， ${middleMap.question.createdDate?string("yyyy/MM/dd HH:mm:ss")}</div>
                                        ...
                                        <div class="zm-item-rich-text expandable js-collapse-body" data-resourceid="123114" data-action="/answer/content" data-author-name="李淼" data-entry-url="/question/19857995/answer/13174385">
                                            <div class="zh-summary summary clearfix">${middleMap.question.content}</div>
                                        </div>
                                    </div>
                                    <div class="feed-meta">
                                        <div class="zm-item-meta answer-actions clearfix js-contentActions">
                                            <div class="zm-meta-panel">
                                                ...
                                                <a href="#" name="addcomment" class="meta-item toggle-comment js-toggleCommentBox">
                                                    <i class="z-icon-comment"></i>${middleMap.question.commentCount} 条评论</a>
